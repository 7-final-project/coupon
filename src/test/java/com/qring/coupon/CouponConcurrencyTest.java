package com.qring.coupon;

import com.qring.coupon.config.YamlPropertySourceFactory;
    ...
    void 쿠폰_여러_명_발급() throws InterruptedException {
        ...
        for (int i = 0; i < threadCount; i++) {
            ...
            executorService.submit(() -> {
                try {
                    optimisticLockFacade.issueCouponByIdWithOptimisticLock(users.get(key), couponId, String.valueOf(key));
