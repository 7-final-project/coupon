...
public interface CouponControllerSwagger {
    ...
    @PostMapping
    ResponseEntity<ResDTO<CouponPostResDTOV1>> postBy(@RequestHeader("X-Passport-Token") String passport,
    ...
    @DeleteMapping("/{id}")
    ResponseEntity<ResDTO<Object>> deleteBy(@RequestHeader("X-Passport-Token") String passport,
                                            @PathVariable Long id);
